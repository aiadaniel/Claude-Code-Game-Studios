...
| `cocos-specialist`  | Cocos Creator   | Sonnet |  Component architecture, asset bundles, TypeScript patterns, multi-platform deployment          |
...
| Agent                          | Subsystem         | Model  | When to Use                                                                 |
| ------------------------------ | ----------------- | ------ | --------------------------------------------------------------------------- |
| `cocos-typescript-specialist` | TypeScript        | Sonnet | Decorator patterns, component lifecycle, design patterns, module organization, TS performance |
| `cocos-shader-specialist`     | Shaders/Rendering | Sonnet | Cocos Effect files (.effect), materials, particles, post-processing         |
| `cocos-ui-specialist`         | UI System         | Sonnet | UI components, multi-resolution adaptation, screen management, UI animation |